...
<head>
    ...
    <title>Privacy Policy by Smart Programming</title>
...
<body>
    ...
    <div class="container-fluid pt-5 pb-3 all-page-heading-banner">
        <div class="container text-center">
            <h4 class="every-page-heading">Privacy Policy</h4>
        </div>
    </div>
    ...
    <div class="container-fluid mt-5 p-5">
        <div class="container">
            ...
            <p>Smart Programming ("us", "we", or "our") operates the http://smartprogramming.in website and the Smart
                Programming mobile application (the "Service").</p>

            <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when
                you use our Service and the choices you have associated with that data. Our Privacy Policy for Smart
                Programming is created with the help of the <a
            ...
            <h6>Types of Data Collected</h6> <br />
            ...
            <p>Smart Programming uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>Smart Programming will take all steps reasonably necessary to ensure that your data is treated securely
            ...
            <h4>Disclosure Of Data</h4> <br />

            <h5>Legal Requirements</h5>
            <p>Smart Programming may disclose your Personal Data in the good faith belief that such action is necessary
                to:</p>
            <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of Smart Programming</li>
            ...
            <p>Our Service does not address anyone under the age of 14 ("Children").</p>
            <p>We do not knowingly collect personally identifiable information from anyone under the age of 14. If you
            ...
            <ul>
                <li>By email: hr.smartprogramming@gmail.com</li>

                <li>By phone number: +91 98887-55565 or +91 62838-30308</li>
            </ul>
        </div>
    </div>
